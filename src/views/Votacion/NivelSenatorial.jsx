...
const NivelSenatorial = () => {
    return (
        <>
            <div style={{ minHeight: "81vh", background: "#c7c8ca", fontSize: "14px" }}>
                <div className="row m-0 p-2 m-auto pt-5" style={{justifyContent: "space-evenly"}}>
                    {data.map(item => <NivelSenatorialCard item={item} key={item.id} />)}
                </div>
            </div>
        </>
    );
...
export default NivelSenatorial;
